...
public class AMInst extends jm.audio.Instrument{
	...
	private int channels;
        //offset value for amplitude modulation 0.0-1.0
        Value offsetAmp;
	...
	public AMInst(int sampleRate){
	    ...
	    this.channels = 1;
            this.offsetAmp = new Value(this, this.sampleRate, this.channels, (float)0.7);
	}
        public AMInst(int sampleRate, int channels){
	    this.sampleRate = sampleRate;
	    this.channels = channels;
            this.offsetAmp = new Value(this, this.sampleRate, this.channels, (float)0.7);
	}

        public AMInst(int sampleRate, int channels, double offsetAmp){
	    this.sampleRate = sampleRate;
	    this.channels = channels;
            this.offsetAmp = new Value(this, this.sampleRate, this.channels, (float)offsetAmp);
	}
	...
	public void createChain(){
		...
		mod.setFrqRatio((float)7.5);
                ...
                offsetAmp = new Value(this, this.sampleRate,
